...
const PRICE_NOW_WARNS = [
  ...
  { cmd: 'rm -rf C:/Users/YOU/AppData/Local/Temp/claude/scratchpad/x', why: 'session scratchpad path' },
  { cmd: 'Remove-Item -Recurse "C:\\Temp\\a b"', why: 'quoted Windows temp path' },
  { cmd: 'Remove-Item -Recurse -Force "C:\\Users\\YOU\\AppData\\Local\\Temp\\forge-x"', why: 'quoted Windows temp path' },

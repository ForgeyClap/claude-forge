...
<!--
  ...
  Forge vendor note: frontmatter license: MIT key and this provenance block added; 5 plugin-namespaced skill reference(s) rewritten to bare skill names so they resolve inside a Forge install; everything else verbatim.

...
<!-- ───────────────────────────────────────────────────────────────────────────
     ...
     posture and the beginner promise. The project payload carries the tools; the
     LITE plugin alone has no settings file and no hooks — offer the full install.
─────────────────────────────────────────────────────────────────────────── -->
...
v2.7.0 subcommands (project-local, after the full install): `/forge config …` · `/forge help me ask` · `/forge interview`.
